package com.mpecel.converters;

import com.mpecel.commands.RecipeCommand;
    ...
    public RecipeCommand convert(Recipe source) {
        ...
        if(source.getCategories() != null && source.getCategories().size() > 0) {
            source.getCategories()
                    .forEach((Category category) -> command.getCategories().add(categoryConverter.convert(category))); // Category??
        }
